...
MODEL_TYPES = {
    'LSTM': {
        ...
        'module': 'src.data.feature_engineering.predictions.sources.lstm_predictor_pytorch',
        'params': {
    ...
    'Transformer': {
        ...
        'module': 'src.data.feature_engineering.predictions.sources.transformer_predictor_pytorch',
        'params': {
            'sequence_length': {'min': 5, 'max': 100, 'default': 20, 'help': 'Input sequence length'},
...
def get_available_stocks() -> List[str]:
    ...
    try:
        ...
        from src.data.database import StockData
...
def _create_predictor(model_type: str, symbol: str, params: Dict[str, Any]):
    ...
    if model_type == 'LSTM':
        from src.data.feature_engineering.predictions.sources.lstm_predictor_pytorch import LSTMPredictorPyTorch
        ...
        from src.data.feature_engineering.predictions.sources.transformer_predictor_pytorch import TransformerPredictorPyTorch
...
def _run_walk_forward_validation(
    ...
    from src.data.feature_engineering.predictions.walk_forward_validator import WalkForwardValidator

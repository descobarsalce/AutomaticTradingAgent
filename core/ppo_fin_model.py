...
#           'max_drawdown':
#           MetricsCalculator.calculate_maximum_drawdown(self.portfolio_history),
#           'sortino_ratio':
...
#             'max_drawdown':
#             MetricsCalculator.calculate_maximum_drawdown(portfolio_history),
#             'volatility':
#             MetricsCalculator.calculate_volatility(returns),
#             'beta':
#             MetricsCalculator.calculate_beta(returns,

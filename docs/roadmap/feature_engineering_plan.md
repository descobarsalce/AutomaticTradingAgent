...
from src.data.feature_engineering.sources import BaseFeatureSource
...
from src.data.data_feature_engineer import FeatureEngineer as LegacyEngineer
...
```python
# Before (old system)
from src.data.data_feature_engineer import FeatureEngineer

...
Handles database exploration and visualization functionality.
"""
...
def render_database_explorer() -> None:
    ...
    unique_symbols = session.query(
        func.count(distinct(StockData.symbol))
    ).scalar()
    ...
    for symbol in symbols:
        ...
        ).group_by(StockData.symbol).first()

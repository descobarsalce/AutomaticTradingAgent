...
def build_trading_env(config: EnvConfig) -> TradingEnv:
    ...
    return TradingEnv(
        ...
        transaction_cost_bps=config.params.get("transaction_cost_bps", 0.0),
        slippage_bps=config.params.get("slippage_bps", 0.0),
        max_daily_loss_pct=config.params.get("max_daily_loss_pct", None),

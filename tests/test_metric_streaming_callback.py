...
sys.modules.setdefault("metrics.metrics_calculator", types.SimpleNamespace(MetricsCalculator=_DummyMetricsCalculator))
...
sys.modules.setdefault("core.visualization", types.SimpleNamespace(TradingVisualizer=_DummyTradingVisualizer))

from core.callbacks.metric_streaming import MetricStreamingEvalCallback
